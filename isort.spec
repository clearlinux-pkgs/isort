...
Source0  : https://files.pythonhosted.org/packages/31/8a/6f5449a7be67e4655069490f05fa3e190f5f5864e6ddee140f60fe5526dd/isort-5.8.0.tar.gz
...
%prep
%setup -q -n isort-5.8.0
cd %{_builddir}/isort-5.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616424814
...
cp %{_builddir}/isort-5.8.0/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.8.0/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
