...
Version  : 5.0.9
Release  : 60
URL      : https://files.pythonhosted.org/packages/94/7b/efc60a4e86dee5d937d142f8055b4625926572bdab3929a42c1573a523f9/isort-5.0.9.tar.gz
Source0  : https://files.pythonhosted.org/packages/94/7b/efc60a4e86dee5d937d142f8055b4625926572bdab3929a42c1573a523f9/isort-5.0.9.tar.gz
...
%prep
%setup -q -n isort-5.0.9
cd %{_builddir}/isort-5.0.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594610970
...
cp %{_builddir}/isort-5.0.9/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.0.9/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
