...
Version  : 5.5.3
Release  : 77
URL      : https://files.pythonhosted.org/packages/a4/ca/629578a00b4e292f55fca902c25fb78fb7ea851a8b5e41c03eb0e45db734/isort-5.5.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/a4/ca/629578a00b4e292f55fca902c25fb78fb7ea851a8b5e41c03eb0e45db734/isort-5.5.3.tar.gz
...
%prep
%setup -q -n isort-5.5.3
cd %{_builddir}/isort-5.5.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600788741
...
cp %{_builddir}/isort-5.5.3/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.5.3/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
