...
Version  : 5.0.7
Release  : 58
URL      : https://files.pythonhosted.org/packages/8f/d0/caa74837e0ee3124ce1be1ad4a2a170939c2559bff42eb5450dbf92a15fc/isort-5.0.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/8f/d0/caa74837e0ee3124ce1be1ad4a2a170939c2559bff42eb5450dbf92a15fc/isort-5.0.7.tar.gz
...
%prep
%setup -q -n isort-5.0.7
cd %{_builddir}/isort-5.0.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594389937
...
cp %{_builddir}/isort-5.0.7/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.0.7/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
