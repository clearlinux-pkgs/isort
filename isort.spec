...
Source0  : https://files.pythonhosted.org/packages/7b/b5/19e828baf02d3e441cd287a3f3cc172bec2d1210c0210294debeddbd3550/isort-5.6.4.tar.gz
...
%prep
%setup -q -n isort-5.6.4
cd %{_builddir}/isort-5.6.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602700097
...
cp %{_builddir}/isort-5.6.4/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.6.4/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
