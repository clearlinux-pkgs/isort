...
Version  : 5.3.0
Release  : 69
URL      : https://files.pythonhosted.org/packages/27/c4/c22799818d2bb0f0c0e6ec6b49840240460901d4a72b4a6ef9e1fa683f84/isort-5.3.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/27/c4/c22799818d2bb0f0c0e6ec6b49840240460901d4a72b4a6ef9e1fa683f84/isort-5.3.0.tar.gz
...
%prep
%setup -q -n isort-5.3.0
cd %{_builddir}/isort-5.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596639953
...
cp %{_builddir}/isort-5.3.0/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.3.0/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
