...
Source0  : https://files.pythonhosted.org/packages/b7/8b/7c2200599c22b4ef6f3688f93c4f44065926bc05cbd38c31247b1348f9a3/isort-5.9.1.tar.gz
...
%prep
%setup -q -n isort-5.9.1
cd %{_builddir}/isort-5.9.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624290134
...
cp %{_builddir}/isort-5.9.1/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.9.1/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
