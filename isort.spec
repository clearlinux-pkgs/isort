...
Version  : 5.0.6
Release  : 57
URL      : https://files.pythonhosted.org/packages/62/ff/9916ae5e99c717f0d46545c0943c4ba43f21e2a08208ae447ef72c4c7ee4/isort-5.0.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/62/ff/9916ae5e99c717f0d46545c0943c4ba43f21e2a08208ae447ef72c4c7ee4/isort-5.0.6.tar.gz
...
%prep
%setup -q -n isort-5.0.6
cd %{_builddir}/isort-5.0.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594306412
...
cp %{_builddir}/isort-5.0.6/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.0.6/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
