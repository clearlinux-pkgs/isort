...
%prep
%setup -q -n isort-5.7.0
cd %{_builddir}/isort-5.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609776943
...
cp %{_builddir}/isort-5.7.0/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.7.0/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
