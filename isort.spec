...
Version  : 5.2.0
Release  : 66
URL      : https://files.pythonhosted.org/packages/93/20/936b71a4a26defc7ec85aea5c2db4e673818f41bdad33ccd381f9d0083e9/isort-5.2.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/93/20/936b71a4a26defc7ec85aea5c2db4e673818f41bdad33ccd381f9d0083e9/isort-5.2.0.tar.gz
...
%prep
%setup -q -n isort-5.2.0
cd %{_builddir}/isort-5.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595865012
...
cp %{_builddir}/isort-5.2.0/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.2.0/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
