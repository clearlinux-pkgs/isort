...
Version  : 5.1.4
Release  : 65
URL      : https://files.pythonhosted.org/packages/37/db/f3944b0b10ec050822fb69e51bf1d0a67095a744938c6a424c05787ad6a3/isort-5.1.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/37/db/f3944b0b10ec050822fb69e51bf1d0a67095a744938c6a424c05787ad6a3/isort-5.1.4.tar.gz
...
%prep
%setup -q -n isort-5.1.4
cd %{_builddir}/isort-5.1.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595257750
...
cp %{_builddir}/isort-5.1.4/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.1.4/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
