...
Source0  : https://files.pythonhosted.org/packages/ac/2a/87e6a7d3c3953ddfb37c6da3fd951490425a60d2ab0be059b321d5788dc8/isort-5.9.2.tar.gz
...
%prep
%setup -q -n isort-5.9.2
cd %{_builddir}/isort-5.9.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625756504
...
cp %{_builddir}/isort-5.9.2/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.9.2/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
