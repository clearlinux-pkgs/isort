...
Version  : 5.0.5
Release  : 56
URL      : https://files.pythonhosted.org/packages/c4/4d/b6286cf463f9cfca698b15524e1198856d68080096f05ca7b3437f0af867/isort-5.0.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/c4/4d/b6286cf463f9cfca698b15524e1198856d68080096f05ca7b3437f0af867/isort-5.0.5.tar.gz
...
%prep
%setup -q -n isort-5.0.5
cd %{_builddir}/isort-5.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594220149
...
cp %{_builddir}/isort-5.0.5/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.0.5/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
