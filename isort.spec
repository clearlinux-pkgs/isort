...
Source0  : https://files.pythonhosted.org/packages/4b/c6/892dd1ad3b6b8d0b33f8ad51255042e5926e4c93b3f0307005d4bc5596a4/isort-5.4.2.tar.gz
...
%prep
%setup -q -n isort-5.4.2
cd %{_builddir}/isort-5.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597677633
...
cp %{_builddir}/isort-5.4.2/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.4.2/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
