...
Version  : 5.5.0
Release  : 73
URL      : https://files.pythonhosted.org/packages/89/d5/645166df7b9df5b244d34add6787d6b6db446ef955aac4122bdad644a584/isort-5.5.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/89/d5/645166df7b9df5b244d34add6787d6b6db446ef955aac4122bdad644a584/isort-5.5.0.tar.gz
...
%prep
%setup -q -n isort-5.5.0
cd %{_builddir}/isort-5.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599157637
...
cp %{_builddir}/isort-5.5.0/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.5.0/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
