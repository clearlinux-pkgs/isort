...
Source0  : https://files.pythonhosted.org/packages/1c/34/ed9178b5b23ade4561bf77b91856e0e3bc094620fd81bd74d535817a0f0d/isort-5.9.3.tar.gz
...
%prep
%setup -q -n isort-5.9.3
cd %{_builddir}/isort-5.9.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627570379
...
cp %{_builddir}/isort-5.9.3/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.9.3/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
