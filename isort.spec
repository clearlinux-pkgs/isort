...
Source0  : https://files.pythonhosted.org/packages/16/2a/79c169c92d95db1ca015c481611b78f5255ef66f8ad8f40276cdcd2e5b68/isort-5.5.4.tar.gz
...
%prep
%setup -q -n isort-5.5.4
cd %{_builddir}/isort-5.5.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601488348
...
cp %{_builddir}/isort-5.5.4/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.5.4/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
