...
Version  : 5.3.2
Release  : 70
URL      : https://files.pythonhosted.org/packages/eb/5e/cb23d644e7371c03667b1d54321f170758bb8f9ef98bdc4635684f172faf/isort-5.3.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/eb/5e/cb23d644e7371c03667b1d54321f170758bb8f9ef98bdc4635684f172faf/isort-5.3.2.tar.gz
...
%prep
%setup -q -n isort-5.3.2
cd %{_builddir}/isort-5.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597079049
...
cp %{_builddir}/isort-5.3.2/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.3.2/isort/_vendored/toml/LICENSE %{buildroot}/usr/share/package-licenses/isort/5e02fc6e946419e35c2f97512cee7fd1a2fe1952
