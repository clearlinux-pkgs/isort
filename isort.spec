...
%prep
%setup -q -n isort-4.3.21
cd %{_builddir}/isort-4.3.21
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583160109
...
cp %{_builddir}/isort-4.3.21/LICENSE %{buildroot}/usr/share/package-licenses/isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
